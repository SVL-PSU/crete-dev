/* This file defines the globals being used by the helper functions
 * that server as dependencies for offline translation to llvm bitcode
 * and symbolic reply.
 */
...
// Originally defined in util/aes.c
